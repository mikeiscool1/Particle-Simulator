...
impl Editor {
    pub fn new(visible: bool, mode: EditorMode) -> Self {
        Self {
            visible,
            mode,
    ...
    pub fn draw_egui(&mut self, ctx: &egui::Context, particles: &mut Particles, state: &mut State) {
        ...
        let panel_response = egui::SidePanel::left("editor_panel")
            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                    ui.selectable_value(&mut self.mode, EditorMode::Particles, "Particles");
                    ui.selectable_value(&mut self.mode, EditorMode::Parametric, "Parametric");
                });
                ui.separator();
                ...
                egui::ScrollArea::vertical().show(ui, |ui| {
                    match self.mode {
                        EditorMode::Particles => {
                            self.draw_particles(ui, particles, state);
                        }
    ...
    fn draw_particles(&mut self, ui: &mut egui::Ui, particles: &mut Particles, state: &mut State) {
        ui.horizontal(|ui| {
    ...
    fn draw_parametric(&mut self, ui: &mut egui::Ui, particles: &mut Particles, state: &mut State) {
        ...
        let apply_clicked = ui.button("Apply Equations").clicked();
        if changed || apply_clicked {
